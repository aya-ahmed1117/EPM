...
<i class="fas fa-paperclip" style="font-size:20px;"></i>nono
</a></div>';}
...
<i class="fad fa-paperclip" style="font-size:20px;"></i></a></div>';}
...
$rows .='<td style="border: 1px solid lightgray;"><a href="?project_id='.$output_query["project_id"].'" class="btn btn-info">Attached</a></td>';
 $rows .='</tr>';
    echo $rows;
